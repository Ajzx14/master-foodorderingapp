...
if(isset($_POST["product_code"]))
{
	...
	$statement = $mysqli_conn->prepare("SELECT product_name, product_price FROM product_list_nv WHERE product_code=? LIMIT 1");
...
if(isset($_POST["load_cart"]) && $_POST["load_cart"]==1)
{
	...
	if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){ //if we have session variable
		...
		$cart_box .= "</ul>";
		$cart_box .= '<div class="cart-products-total">Total : '.$currency.sprintf("%01.2f",$total).' <u><a href="view_cart.php" class="cart-box" title="Review Cart and Check-Out">Check-out</a></u></div>';
