					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						 <nav class="linkEffects linkHoverEffect_12">
							<ul style="padding-left:20px">
								...
								<li><a href="#"><span>vegians</span></a></li> 
								<li><a href="non_veg.php"><span>Non-vegians</span></a></li> 
								<li><a href="#" class="scroll"><span>Offers</span></a></li> 
								<li><a href="#contact" class="scroll"><span>Contact Us</span></a></li> 
...
<div class="clearfix"> </div>	
<!--php--><div>
    <h3 class="title">SUB for vegians</h3>
